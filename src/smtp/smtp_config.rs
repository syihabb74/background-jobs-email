...
use crate::{cli::prompt, smtp::{auth_mechanism::AuthMechanism, smtp_server::{LiveSmtp, SmtpCredential}, tcp_com::read_response}};
...
impl SmtpConfig {
    ...
    pub fn new() -> Self {
        ...
        let _ = prompt("Insert your relay here \nExample smtp.gmail.com:587", &mut host);
